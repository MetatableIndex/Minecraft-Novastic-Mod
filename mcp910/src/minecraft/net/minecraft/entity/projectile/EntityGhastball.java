...
public class EntityGhastball extends EntityThrowable
{
    ...
    protected void onImpact(MovingObjectPosition par1MovingObjectPosition)
    {
    	if (!this.worldObj.isRemote)
        {
            ...
            {
                int var2 = par1MovingObjectPosition.func_178782_a().getX();
                int var3 = par1MovingObjectPosition.func_178782_a().getY();
                int var4 = par1MovingObjectPosition.func_178782_a().getZ();

                switch (par1MovingObjectPosition.field_178784_b.getIndex())
                {
                    case 0:
                        --var3;
                        break;
                ...
                {
                    this.worldObj.setBlockState(position, Blocks.fire.getDefaultState());
                    this.playGhastMobSound();
                    this.explode();
                }
            }
