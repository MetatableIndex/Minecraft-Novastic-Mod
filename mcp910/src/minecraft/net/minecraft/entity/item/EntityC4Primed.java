...
public class EntityC4Primed extends Entity
{
    ...
    public int fuse;
    private EntityLivingBase c4PlacedBy;
    private static final String __OBFID = "CL_00001681";

    public EntityC4Primed(World worldIn)
    {
        super(worldIn);
    ...
    public EntityC4Primed(World worldIn, double p_i1730_2_, double p_i1730_4_, double p_i1730_6_, EntityLivingBase p_i1730_8_)
    {
        this(worldIn);
     ...
     */
    public EntityLivingBase getC4PlacedBy()
    {
        return this.c4PlacedBy;
    }
