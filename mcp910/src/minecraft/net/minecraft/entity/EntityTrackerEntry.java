...
public class EntityTrackerEntry
{
    ...
    private Packet func_151260_c()
    {
        ...
        else if (this.trackedEntity instanceof EntityGhastball)
        {
        	return new S0EPacketSpawnObject(this.trackedEntity, 64);
        }
        ...
        else
        {
            ...
            else if (this.trackedEntity instanceof EntityC4Primed)
            {
                return new S0EPacketSpawnObject(this.trackedEntity, 52);
            }
