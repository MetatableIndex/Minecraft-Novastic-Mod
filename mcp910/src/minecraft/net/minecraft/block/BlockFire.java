...
public class BlockFire extends Block
{
    ...
    public static void func_149843_e()
    {
        ...
        Blocks.fire.func_180686_a(Blocks.c4, 15, 100);
    ...
    private void func_176536_a(World worldIn, BlockPos p_176536_2_, int p_176536_3_, Random p_176536_4_, int p_176536_5_)
    {
        ...
        if (p_176536_4_.nextInt(p_176536_3_) < var6)
        {
            ...
            else if (var7.getBlock() == Blocks.c4)
            {
                Blocks.c4.onBlockDestroyedByPlayer(worldIn, p_176536_2_, var7.withProperty(BlockC4.field_176246_a, Boolean.valueOf(true)));
            }
        }
    }
