...
public class Block
{
    ...
    public static void registerBlocks()
    {
        ...
        registerBlock(198, "iron_button", (new BlockIronButton()).setHardness(1.0F).setStepSound(soundTypeMetal).setUnlocalizedName("ironbutton"));
        registerBlock(199, "c4", (new BlockC4()).setHardness(0.0F).setStepSound(soundTypeGrass).setUnlocalizedName("c4"));
