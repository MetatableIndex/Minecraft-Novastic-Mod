...
import net.minecraft.block.BlockC4;
...
import net.minecraft.entity.item.EntityC4Primed;
...
public class Bootstrap
{
    ...
    static void registerDispenserBehaviors()
    {
        ...
        BlockDispenser.dispenseBehaviorRegistry.putObject(Items.ghastball, new BehaviorProjectileDispense()
        {
            private static final String __OBFID = "CL_00001414";
            protected IProjectile getProjectileEntity(World worldIn, IPosition position)
            {
                return new EntityGhastball(worldIn, position.getX(), position.getY(), position.getZ());
            }
        });
        ...
        BlockDispenser.dispenseBehaviorRegistry.putObject(Items.flint_and_steel, new BehaviorDefaultDispenseItem()
        {
            ...
            protected ItemStack dispenseStack(IBlockSource source, ItemStack stack)
            {
                ...
                else if (var3.getBlockState(var4).getBlock() == Blocks.c4)
                {
                    Blocks.c4.onBlockDestroyedByPlayer(var3, var4, Blocks.c4.getDefaultState().withProperty(BlockC4.field_176246_a, Boolean.valueOf(true)));
                    var3.setBlockToAir(var4);
                }
                else
                {
        ...
        BlockDispenser.dispenseBehaviorRegistry.putObject(Item.getItemFromBlock(Blocks.c4), new BehaviorDefaultDispenseItem()
        {
            private static final String __OBFID = "CL_00001403";
            protected ItemStack dispenseStack(IBlockSource source, ItemStack stack)
            {
                World var3 = source.getWorld();
                BlockPos var4 = source.getBlockPos().offset(BlockDispenser.getFacing(source.getBlockMetadata()));
                EntityC4Primed var5 = new EntityC4Primed(var3, (double)var4.getX() + 0.5D, (double)var4.getY(), (double)var4.getZ() + 0.5D, (EntityLivingBase)null);
                var3.spawnEntityInWorld(var5);
                var3.playSoundAtEntity(var5, "game.tnt.primed", 1.0F, 1.0F);
                --stack.stackSize;
                return stack;
