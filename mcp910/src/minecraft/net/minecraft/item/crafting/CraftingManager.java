...
public class CraftingManager
{
    ...
    private CraftingManager()
    {
        ...
        this.addRecipe(new ItemStack(Blocks.c4, 1), new Object[] {"#X#", "X#X", "#X#", 'X', Items.gunpowder, '#', Blocks.sand});
        ...
        this.addRecipe(new ItemStack(Blocks.iron_button, 1), new Object[] {"#", '#', new ItemStack(Blocks.iron_block, 1, Blocks.iron_block.getMetaFromState(Blocks.iron_block.getDefaultState()))});
